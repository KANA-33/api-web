...
| Admin user OAuth bindings     | GET      | `/api/user/:id/oauth/bindings`                              | Admin session | Lists custom OAuth provider bindings for target user                  |
| Admin user OAuth unbind       | DELETE   | `/api/user/:id/oauth/bindings/:provider_id`                 | Admin session | Unbinds one custom OAuth provider                                     |
| Admin clear user binding      | DELETE   | `/api/user/:id/bindings/:binding_type`                      | Admin session | Clears email, GitHub, Discord, OIDC, WeChat, Telegram, or Linux.do    |
| Admin reset user passkey      | DELETE   | `/api/user/:id/reset_passkey`                               | Admin session | Removes bound passkey if present                                      |
...
| Invalidate user subscription  | POST     | `/api/subscription/admin/user_subscriptions/:id/invalidate` | Admin session | Cancels immediately, may downgrade group                              |
| Delete user subscription      | DELETE   | `/api/subscription/admin/user_subscriptions/:id`            | Admin session | Hard-deletes one user subscription                                    |
