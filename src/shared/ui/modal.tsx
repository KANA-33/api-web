...
export function Modal({
  ...
  return createPortal(
    ...
    >
      <div
        className={cn(
          "max-h-[min(86vh,820px)] w-full max-w-2xl overflow-hidden rounded-xl border border-[#d7cec6] bg-[#fffdf8] text-[#181614] shadow-[0_32px_90px_rgb(31_24_18_/_0.22),inset_0_1px_0_rgb(255_255_255_/_0.7)] animate-[modalPanelIn_220ms_cubic-bezier(0.16,1,0.3,1)]",
          className,
        )}
        onClick={(event) => event.stopPropagation()}
      >
        <div className="flex items-start justify-between gap-5 border-b border-[#ddd4ca] bg-[#f8f4ee]/84 px-6 py-4">
          <div className="min-w-0">
            <h2 className="text-xl font-semibold leading-tight tracking-[-0.025em] text-[#1f1a16]">
              {title}
            </h2>
            {description && (
